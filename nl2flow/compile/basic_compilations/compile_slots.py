...
def compile_slots(compilation: Any, **kwargs: Dict[str, Any]) -> None:
    ...
    for constant in compilation.constant_map:
        if is_this_a_datum(compilation, constant):
            ...
            for slot in flow_definition.slot_properties:
                if (
    ...
    compile_new_object_maps(
        compilation, not_slots, not_slotfillable_types, num_lookahead
    )
