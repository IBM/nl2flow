...
from nl2flow.printers.driver import pre_process_plan_str
...
class TestVerbalizePrint:
    ...
    def test_pre_process_plan_str(self) -> None:
        llm_response = (
        ...
        action_strs = pre_process_plan_str(
            tokens_str=llm_response, available_agents=available_agents, no_plan_str="no plan", plan_header="PLAN"
        )
