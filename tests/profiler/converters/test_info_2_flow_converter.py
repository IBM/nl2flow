...
class TestInfo2FlowConverter(unittest.TestCase):
    ...
    def test_get_operators_for_flow(self):
        item: AgentInfoSignatureItem = {"name": "k", "sequence_alias": "j"}
    ...
    def test_get_goals_for_flow(self):
        goals = {"a", "b"}
