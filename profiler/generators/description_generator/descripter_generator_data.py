ask_description = (
    ...
    + " Action ask is less preferred than acquiring the value of a variable through other actions."
...
ask_last_resort_description = (
    ...
    + " Action ask-last-resort can ask the user about the value of a variable only when there is no other possible option to obtain the value."
